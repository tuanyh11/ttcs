...
const defaultColumn = ['Product Name', 'Category', 'Price', 'Sold', 'action']; 

const TableTwo = ({ column = defaultColumn }: Props) => {
  return (
...
{/* 
      <div className=" border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
        {column.map((item) => {
          return (
            <div key={item} className="col-span-1 flex items-center">
      ...
      <div className="grid grid-cols-6 border-t border-stroke py-4.5 px-4 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
        ...
        <div className="col-span-1 flex items-center">
          <p className="font-medium capitalize">Profit</p>
        </div>
      </div>

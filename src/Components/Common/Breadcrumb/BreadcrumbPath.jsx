...
const BreadcrumbPath = ({ pathname }) => {
  return (
    <div className="elementor flex relative ml-auto mr-auto h-64 ">
      <div
        className="relative z-[1] w-full flex h-full bg-[url(https://klbtheme.com/chakta/wp-content/plugins/chakta-core/elementor/images/breadcrumb.jpg)] 
            ...
            <div className="w-2/3">
              <div className="relative px-4 w-full">
                <div className="breadcrumbs-content text-center">
                  <h1 className="text-white font-semibold md:text-[60px] text-[32px] mb-3">
                    {pathname}
                  </h1>

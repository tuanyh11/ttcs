    ...
    <div>
      <div className="md:w-[560px] m-auto p-[15px] mb-[10px] w-full">
        ...
        <p className="text-center">
          Thành viên của nhóm của chúng tôi là những chuyên gia có kinh nghiệm
          và tâm huyết với lĩnh vực phụ kiện ô tô
        </p>
      </div>
        ...
        {teamMembers.map((item, index) => (
          <div className="xl:w-1/4 sm:w-1/2 p-[15px] w-full " key={index}>
            <div className="p-[35px] border text-center cursor-pointer">
              ...
              >
                {(close) => <PopupDetail data={item} close={close} />}
              </Popup>
              ...
              <Popup
                ...
                trigger={
                  <p
                    ...
                    className="check-box-list"
                  >
                    <h5 className="text-[18px] font-poppins text-dark-color font-semibold">
                      {item.name}
                    </h5>
                  </p>
                }

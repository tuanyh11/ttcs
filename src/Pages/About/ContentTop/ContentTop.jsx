      ...
      <div className="lg:w-1/2 w-full">
        <div className="p-[15px]">
          <div className="relative">
            <img
              src={contentTop.images[0].image.mediaItemUrl}
              alt=""
              className="absolute top-[100px] lg:right-0 right-[10%]"
            />
            <div>
              <img
                src={contentTop.images[1].image.mediaItemUrl}
                alt=""
                className="m-auto"
              />
            </div>
      ...
      <div className="lg:w-1/2 w-full">
        <div className="p-[15px]">
          <div className="xl:px-[100px] px-[15px] ">
            <span className="text-main-color inline-block mb-[10px] capitalize">
              Giới thiệu về chúng tôi
            </span>
            <h2 className="mb-[15px] sm:text-[27px] capitalize sm:leading-[32px] font-poppins font-semibold text-dark-color text-[28px] leading-[40px] ">
              Khám phá các giải pháp độ xe ô tô tuyệt vời
            </h2>
            ...
            >
              Đọc Thêm
              <i className="fa-solid fa-circle-right ml-[10px] text-[14px]"></i>
            </Link>
          </div>
        </div>
      </div>
